/**
 ...
 TASK 1
 	...
 	2. Compile the program with g++ -o tut tut.cpp --std=c++11 and run using ./tut
 ...
 TASK 3
	 ...
	 ***********************************************************
	 *** Type your answers in a text file and submit on Vula ***
	 ***********************************************************
...
public:
	std::size_t get_index()	{ return my_index; }
	std::string get_value() { return datum; }
	virtual ~Node(){}
};
